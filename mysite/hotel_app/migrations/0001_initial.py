    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(default=18, validators=[django.core.validators.MinValueValidator(18), django.core.validators.MaxLengthValidator(75)])),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='996', max_length=128, region='KG')),
                ('status', models.CharField(choices=[('client', 'client'), ('owner', 'owner')], default='client', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_status', models.CharField(choices=[('Свободен', 'Свободен'), ('Забронировано', 'Забронировано')], default='Свободен', max_length=20)),
