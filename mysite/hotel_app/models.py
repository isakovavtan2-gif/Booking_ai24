...
class UserProfile(AbstractUser):
    age = models.PositiveSmallIntegerField(validators=[MinValueValidator(18), MaxLengthValidator(75)], default=18)
    phone_number = PhoneNumberField(region='KG', default='996')
    USER_STATUS = (
    ('client', 'client'),
    ('owner', 'owner')
    )
    status = models.CharField(max_length=10, choices=USER_STATUS, default='client')
...
class Room(models.Model):
    ...
    room_status = models.CharField(max_length=20, choices=ROOM_STATUS, default='Свободен')
