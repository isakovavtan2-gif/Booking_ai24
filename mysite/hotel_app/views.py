...
from .serializers import (UserProfileSerializers, CountryListSerializers,
                          CountryDetailSerializers,CityListSerializers,
                          CityDetailSerializers,ServicesSerializers,
                          HotelListSerializers, HotelDetailSerializers,ImageHotelSerializers,
                          RoomSerializers, ImageRoomSerializers,
                          ReviewSerializers, BookingSerializers, LoginSerializer, UserSerializer)
from rest_framework import viewsets, generics, permissions, status
from django_filters.rest_framework import DjangoFilterBackend
from rest_framework.filters import SearchFilter, OrderingFilter
from .filtr import HotelFilter, RoomFilter
from .permissions import CheckStatusUser, CheckOwner
...
class HotelDetailViewSet(generics.RetrieveUpdateDestroyAPIView):
    ...
    permission_classes = [permissions.IsAuthenticatedOrReadOnly, CheckStatusUser, CheckOwner]
