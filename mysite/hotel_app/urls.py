from .views import (UserProfileViewSet, CountryListViewSet, CountryDetailViewSet, CityListViewSet,
                    CityDetailViewSet, ServicesViewSet,
                    HotelListViewSet, HotelDetailViewSet, ImageHotelViewSet, RoomViewSet,
